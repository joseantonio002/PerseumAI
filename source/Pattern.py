class Pattern:
    ...
    def __init__(self, pattern_type, dataframe_segment, company_name, starting_date, ending_date, tendency, distance, points = None, source = "DTW"):
